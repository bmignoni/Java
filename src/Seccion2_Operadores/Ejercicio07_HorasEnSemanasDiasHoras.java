...
devuelve el numero de semanas, dias y horas equivalentes. Por ejemplo, dado
...
public class Ejercicio07_HorasEnSemanasDiasHoras {
    ...
    public static void main (String[] args){
        ...
        semanas = horasTotales / 168; // 7 dias * 24 horas = 168hs
